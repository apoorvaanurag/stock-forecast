...
app = dash.Dash(
    ...
    external_stylesheets=[
        "https://fonts.googleapis.com/css2?family=Readex+Pro:wght@300&display=swap"
    ])
server = app.server
# html layout of site
app.layout = html.Div(
    [
        html.Div(
            [
                # Navigation
                html.P("Welcome to the Stock-Forecast App!", className="start"),
                html.Div([
                    html.P("Stock Code: "),
                    html.Div([
...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        ...
        return "Hey there! Please enter a legitimate stock code to get details.", "https://raw.githubusercontent.com/Konteya/stock-forecast/main/assets/25-stocks-that-can-offer-up-to-48-returns-over-12-months-according-to-stock-reports-plus.png", "Stocks Forecast", "hello", "what", "UPPIPIPI"
